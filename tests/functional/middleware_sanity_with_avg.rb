...
options = %W(--port #{middleware_port} --graphite tcp://localhost:#{fake_carbon_port} --interval 10 --aggregation-method avg -L debug -l #{middleware_log_file})
